...
+ [Security in CodeArtifact](security.md)
   ...
   + [Identity and access management in AWS CodeArtifact](auth-and-access-control-aca.md)
      ...
      + [Using tags to control access to CodeArtifact resources](tag-based-access-control.md)
...
+ [Creating CodeArtifact resources with AWS CloudFormation](cloudformation-codeartifact.md)
